...
document.addEventListener("click", (e)=>{
    ...
    if (wall) {
        ...
        if (getSidePosition < 0) getSidePosition = 0;
        if (getTopPosition > maxTopPosition) getTopPosition = maxTopPosition;
        if (getSidePosition > maxSidePosition) getSidePosition = maxSidePosition;
        if (getTopPosition < 0) getTopPosition = 0;
